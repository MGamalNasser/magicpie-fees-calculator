      ...
      <div className="w-full max-w-sm">
        ...
        <div className="card p-6 shadow-md">
          ...
          <Button
            ...
            onClick={async () => {
              ...
              try {
                ...
                if (res.error) setError(t("Google sign-in is not configured yet."))
              } catch {
                setError(t("Google sign-in is not configured yet."))
              } finally {
                setGoogleBusy(false)
              }
            }}
          >
            ...
            {googleBusy ? t("Redirecting…") : t("Continue with Google")}
          </Button>
        </div>
